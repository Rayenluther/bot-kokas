...
/////////////////
const BotName = 'BOT-KOKAS☄'; 
const instagram = 'https://instagram.com/rayennluther'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@rayennluther')
